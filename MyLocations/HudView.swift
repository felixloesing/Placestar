...
class HudView: UIView {
    ...
    func showAnimated(animated: Bool) {
        if animated {
            ...
            //spring animation
            UIView.animateWithDuration(0.4, delay: 0, usingSpringWithDamping: 0.8, initialSpringVelocity: 0.6, options: UIViewAnimationOptions(rawValue: 0), animations: { () -> Void in
                self.alpha = 1
